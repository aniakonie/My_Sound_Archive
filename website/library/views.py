...
def library():
    ...
    if request.method == "POST":
        ...
        return redirect(url_for("library_bp.library_folders", selected_folder = selected_folder))

    return render_template("library/library.html", folders = folders, current = "library")


# @library_bp.route('/<selected_folder>', methods=["POST", "GET"])
...
#     return render_template("library/library.html", artists_folders = artists_folders, folders=folders, current = "library")
